...
from semilearn.algorithms.utils import str2list
...
def get_config():
    ...
    parser.add_argument('--use_improved_ema', default=False, type=str2bool)
    ...
    parser.add_argument('--use_scheduler', type=str2bool, default=False, help='use cosine annealing or multistep scheduler for imbalanced algorithms')
    parser.add_argument('--scheduler_type', type=str, default='cosine', help='Scheduler type: cosine, multistep. Default: cosine.')
    parser.add_argument('--multistep_milestones', type=str2list(dtype=int), default=(200 * 1000, 225 * 1000),
                        help='List of milestones (in steps) for multi-step scheduler decreases LR. Default: [200k, 225k].')
    ...
    parser.add_argument('--labeled_transform', type=str, default='weak',
                        help="augment labeled data with 'weak', 'strong' or 'both' transformations, default to 'weak' (currently supported by CIFAR datasets)")
    parser.add_argument('--return_lb_in_ulb_mask', type=str2bool, default=False,
                        help='return mask indicating labeled data within unlabeled data, default to False (currently supported by CIFAR, STL10, TissueMNIST and EuroSAT datasets)')
