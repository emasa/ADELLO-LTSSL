...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=1000, rotation=False, rotnet=None, classifier_bias=True):
        ...
        self.classifier = nn.Linear(512*block.expansion, num_classes, bias=classifier_bias)
