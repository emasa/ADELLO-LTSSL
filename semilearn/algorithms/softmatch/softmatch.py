...
class SoftMatch(AlgorithmBase):
    ...
    def __init__(self, args, net_builder, tb_log=None, logger=None):
        ...
        self.init(T=args.T, hard_label=args.hard_label, dist_align=args.dist_align, dist_uniform=args.dist_uniform,
                  smooth_p_target=args.smooth_p_target, smooth_p_model=args.smooth_p_model,
    ...
    def train_step(self, x_lb, y_lb, x_ulb_w, x_ulb_s):
        ...
        with self.amp_cm():
            ...
            # callback (usually computes softmax. UDAL keeps track of running average)
            ...
            pseudo_label = self.call_hook("gen_ulb_targets", "PseudoLabelingHook", 
                                          ...
                                          logits=logits_x_ulb_w if self.use_hard_label else torch.softmax(logits_x_ulb_w / self.T, dim=-1),
