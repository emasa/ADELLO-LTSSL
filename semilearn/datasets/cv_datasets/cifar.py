...
def get_cifar(args, alg, name, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True,
    ...
    assert labeled_transform in ('weak', 'strong', 'both')
    ...
    lb_data, lb_targets, ulb_data, ulb_targets, lb_in_ulb_mask = split_ssl_data(args, data, targets, num_classes,
    ...
    lb_dset = BasicDataset(alg, lb_data, lb_targets, num_classes,
                           transform_weak if labeled_transform in ('weak', 'both') else None, False,
                           transform_strong if labeled_transform in ('strong', 'both') else None, False)
