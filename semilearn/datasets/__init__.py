...
from semilearn.datasets.cv_datasets import get_cifar, get_eurosat, get_imagenet, get_small_imagenet, get_medmnist, get_semi_aves, get_stl10, get_svhn, get_food101
